...
class PartnersProvider
{
    ...
    private function mapPost(\WP_Post $post): Partner
    {
        ...
        $data = [
            ...
            'awin_advertiser_id' => (int) $meta('awin_advertiser_id'),
            'awin_cashback_enabled' => $this->toBool($meta('awin_cashback_enabled')),
            'awin_cashback_percent' => $this->toNumber($meta('awin_cashback_percent')),
            'awin_logo_url' => (string) $meta('awin_logo_url'),
            'awin_click_through_url' => (string) $meta('awin_click_through_url'),
            'awin_offers' => $meta('awin_offers'),
